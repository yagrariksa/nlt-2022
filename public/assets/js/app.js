...
$('.btn-img').mouseover(function (e) {
  var paths = e.currentTarget.getElementsByTagName('path');
...
var selectLength = selectItem.length; //l
...
for (var i = 0; i < selectItem.length; i++) {
  ...
  for (var j = 1; j < selectElement.length; j++) {
    var newOptionElm = document.createElement('div');
...
var checkChange = function checkChange() {
  inputWillCHangeLabel.map(function (i) {
...
/******/ 	__webpack_require__.O(undefined, ["assets/scss/app"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/scss/app"], () => (__webpack_require__("./resources/sass/app.scss")))
